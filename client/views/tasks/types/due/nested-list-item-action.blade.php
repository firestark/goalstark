@if ( $tasks [ 0 ]->completed )
    <a  href="/goals/{{ $tasks [ 0 ]->goal->id }}/tasks/{{ $tasks [ 0 ]->id }}/uncomplete" 
...
@else
    <a  href="/goals/{{ $tasks [ 0 ]->goal->id }}/tasks/{{ $tasks [ 0 ]->id }}/complete" 
        class="mdc-list-item__graphic {{ ( $tasks [ 0 ]->due < time ( ) ) ? 'overdue' : '' }}" 
        aria-hidden="true">
